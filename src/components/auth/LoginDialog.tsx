...
import { LogIn, Users, Award, BookOpen, Star, Sparkles, Lock, GlobeIcon, MessageSquare } from "lucide-react";
        ...
        <DialogContent className="sm:max-w-md max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription className="text-center text-base">
              {message || "Use your World Samma account to join global conversations"}
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <p
                className="w-full font-semibold text-base text-center"
              >
